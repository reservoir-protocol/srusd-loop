...
import {ReservoirLooperSrusdUsdc} from "../../src/ReservoirLooperSrusdUsdc.sol";
...
contract ReservoirLooperSrusdUsdcTestSetup is Test {
    using MarketParamsLib for MarketParams;

    ReservoirLooperSrusdUsdc public looper;
    ...
    function setUp() external {
        ...
        looper = new ReservoirLooperSrusdUsdc(address(this));
        ...
        ICreditEnforcer(CREDITENFORCER_ADDRESS).setPSMDebtMax(
            type(uint256).max
        );
        ...
        // deal some usdc to PSM
        deal(USDC_ADDRESS, PSM_ADDRESS, 1_000_000_000_000e6, true);
        ...
        // provide usdc liquiditiy to the market
        deal(USDC_ADDRESS, address(1), 1_000_000_000_000e18, true);
        vm.startPrank(address(1));
        IERC20(USDC_ADDRESS).approve(address(morpho), 1_000_000_000_000e18);
